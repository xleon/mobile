...
namespace Toggl.Phoebe.Data.Models
{
    ...
    public class TimeEntryData : CommonData, ITimeEntryData
    {
        ...
        public string RawTagIds
        {
            get
            {
                return string.Join(tagSplitCharacter.ToString(), Tags);
            }
            set
            {
                Tags = value.Split(new char[] { tagSplitCharacter }, StringSplitOptions.RemoveEmptyEntries)
                       .ToList();
            }
        }
