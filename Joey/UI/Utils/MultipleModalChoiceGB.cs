...
namespace Toggl.Joey.UI.Utils
{
    ...
    /// </summary>
    internal class MultipleModalChoiceGB : MultipleModalChoiceShim, ActionMode.ICallback
    {
        ...
        public MultipleModalChoiceGB (Activity activity, ListView listView, ActionMode.ICallback actionHandler)
        {
